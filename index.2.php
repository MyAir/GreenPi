...
// $g_table_log = "datalogger";
$g_table_log = "current_log";
...
<?php
  ...
  $sql = "SELECT temperature FROM $g_table_log where sensor = 6 ORDER BY date_time DESC LIMIT 1";
...
$sql = "SELECT humidity FROM $g_table_log where sensor = 6 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT moisture FROM $g_table_log where sensor = 0 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT quality FROM $g_table_log where sensor = 1 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT temperature FROM $g_table_log where sensor = 7 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT humidity FROM $g_table_log where sensor = 7 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT temperature FROM $g_table_log where sensor = 8 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT humidity FROM $g_table_log where sensor = 8 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$q=   "select date_time, IFNULL( 	moist_avg, 0) as moisture from $tb_hist_hour "; 
$q=$q."where sensor = 0 "; 
...
$q=   "select date_time, IFNULL( 	qual_avg, 0) as quality from $tb_hist_hour "; 
$q=$q."where sensor = 1 "; 
$q=$q."order by date_time desc "; 
$q=$q."limit 24"; 
$ds=mysql_query($q);  
...
$q=   "select date_time, IFNULL(humi_avg,0) as humidity from $tb_hist_hour "; 
$q=$q."where sensor = 7 "; 
$q=$q."order by date_time desc "; 
$q=$q."limit 24"; 
$ds=mysql_query($q);  
...
$q=   "select date_time, IFNULL(temp_avg, 0) as temperature from $tb_hist_hour "; 
$q=$q."where sensor = 7 "; 
$q=$q."order by date_time desc "; 
$q=$q."limit 24"; 
$ds=mysql_query($q); 
