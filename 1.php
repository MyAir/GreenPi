  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawDashboard() {
        ...
        data.addRows([
            <?php 
              $result = getValues($tb_current, 7, ['date_time','temperature', 'humidity',
    ...
    <script type="text/javascript">
      ...
      function drawDashboard() {
        ...
        data.addRows([
            <?php 
              $result = getValues($tb_hist_quart, 7, ['date_time','temp_avg', 'humi_avg'],672);
              for($r=0;$r<count($result);$r++){
                echo "[new Date(".(strtotime($result[$r][0])*1000)."), "; 
                echo " ".$result[$r][1].", "; 
                echo " ".$result[$r][2].", ";
    ...
    <script type="text/javascript">
      ...
      function drawDashboard() {
        ...
        data.addRows([
            <?php 
              $result = getValues($tb_hist_hour, 7, ['date_time','temp_avg', 'humi_avg'],720);
              for($r=0;$r<count($result);$r++){
                echo "[new Date(".(strtotime($result[$r][0])*1000)."), "; 
                echo " ".$result[$r][1].", "; 
                echo " ".$result[$r][2].", ";
  ...
  <body>
    <div class="jumbotron">
      <div class="container">
        ...
        <h2>Temperature and Humidity Sensor Bottom</h2>
